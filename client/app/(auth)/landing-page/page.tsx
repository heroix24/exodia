...
export default function LandingPage() {
  ...
  return (
    <div id="top" className="min-h-screen bg-[#fff6ed] text-[#424242]">
      ...
      <header className="sticky top-0 z-50 bg-[#fff6ed]/95 backdrop-blur-sm">
        <div className="mx-auto flex max-w-[1000px] items-center justify-between px-4 py-4 md:px-5 md:py-5">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <Button
              asChild
              className="hidden bg-[#0d7239] px-4 py-2 text-sm font-semibold text-[#fff6ed] hover:bg-[#0a5c2d] md:inline-flex"
            >
              <Link href="/register-page">Get Started</Link>
            </Button>
            <button
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-[#fff6ed] border-t border-[#0d7239]/20 px-4 py-4">
            <nav className="flex flex-col gap-4">
              ...
              <Button
                asChild
                className="w-full bg-[#0d7239] px-4 py-2 text-sm font-semibold text-[#fff6ed] hover:bg-[#0a5c2d]"
              >
                <Link href="/register-page" onClick={() => setMobileMenuOpen(false)}>
                  Get Started
                </Link>
              </Button>
            </nav>
      ...
      <section
        id="product"
        className="border-b border-l border-r border-dashed border-[rgba(13,114,57,0.5)] mx-4 md:mx-auto max-w-[1000px] overflow-hidden"
      >
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-10 px-4 md:px-5 py-8 md:py-10">
          <div className="flex flex-col gap-6 md:gap-8 max-w-full lg:max-w-[387px] text-center lg:text-left">
            ...
            <Button
              asChild
              className="w-full sm:w-fit mx-auto lg:mx-0 bg-[#0d7239] px-4 py-4 text-sm md:text-base font-semibold text-[#fff6ed] hover:bg-[#0a5c2d]"
            >
              <Link href="/register-page">Start Convert Sheets</Link>
            </Button>
          </div>
      ...
      <section
        id="features"
        className="border-b border-l border-r border-dashed border-[rgba(13,114,57,0.5)] mx-4 md:mx-auto max-w-[1000px] overflow-hidden px-4 md:px-5 py-6 md:py-8"
      >
